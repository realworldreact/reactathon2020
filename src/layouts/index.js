    ...
    <div>
      <Helmet
        ...
        meta={[
          {
            name: 'description',
            content:'3-day dual-conference & hackathon in San Francisco featuring the brightest minds in the JS/React community.'
          },
          {
            name: 'keywords',
            content:
          ...
          {
            content: 'https://s3-us-west-1.amazonaws.com/reactathon-2018/reactathon-og-image.png',
            property: 'og:image'
          },
          {
            content: 'article',
          ...
          {
            content: 'https://s3-us-west-1.amazonaws.com/reactathon-2018/reactathon-twitter-card.png',
